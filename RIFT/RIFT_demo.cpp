...
int main(int argc, char* argv[])
{
	...
	for (int i=1;i<20;i++)
	{
		printf("pic num: %d\n", i);
		char irPath[100];
		// sprintf(irPath, "/home/cza/yjt/Helmet/RIFT/test/ir/%d.jpg",i);
		sprintf(irPath, "/home/cza/cropter/RIFT/dataset/IR/%02d.jpg",i);
		char viPath[100];
		// sprintf(viPath, "/home/cza/yjt/Helmet/RIFT/test/vis/%d.jpg",i);
		sprintf(viPath, "/home/cza/cropter/RIFT/dataset/VI/%02d.jpg",i);
